...
//    [SVProgressHUD showWithMaskType:SVProgressHUDMaskTypeBlack];
    ...
    params[@"a"] = @"category";
    params[@"c"] = @"subscribe";
    [self.manager GET:@"https://api.budejie.com/api/api_open.php" parameters:params progress:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        // 隐藏指示器
...
- (void)loadNewUsers
{
    RecommendCategory *rc = CYSelectedCategory;
...
- (void)loadMoreUsers
{
    RecommendCategory *category = CYSelectedCategory;
